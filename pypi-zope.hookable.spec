...
Source0  : https://files.pythonhosted.org/packages/78/ce/4eeb5f4d12bfb6ba46584c3e7cd0b8f29264b10a9159eaf06d90f71a22a9/zope.hookable-6.0.tar.gz
...
%prep
%setup -q -n zope.hookable-6.0
cd %{_builddir}/zope.hookable-6.0
pushd ..
cp -a zope.hookable-6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696520586
